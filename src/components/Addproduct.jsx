...
class Addproduct extends Component {
    ...
    addProduct = () => {
        switch (true) {
            case this.state.renderpic1 === "images/productpics/nopic.png" || this.state.renderpic2 === "images/productpics/nopic.png" || this.state.renderpic3 === "images/productpics/nopic.png":
                alert("Please upload 3 product picture")
                break;
            case !this.state.category:
                alert("Please select a category")
                break;
            case !this.state.measurement:
                alert("Please select the measurement")
                break;
                    ...
                    <div className="mt-3 mx-5" id="curtain">
                        ...
                        <Row className="mb-3">
                            <Card style={{ width: "300px" }} className="mr-3">
                                ...
                                <CardImg className="mx-auto mt-3 border" src={"http://localhost:5555/" + this.state.renderpic1} style={{ height: "250px", width: "250px", objectFit: "cover" }} alt="Card image cap" />
                                ...
                                <CardFooter>
                                    <Button disabled={!this.state.productpic1} onClick={() => this.uploadPic1()} >Upload</Button>
                                </CardFooter>
                            </Card>
                            <Card style={{ width: "300px" }} className="mr-3">
                                <CardHeader>Product Picture 2</CardHeader>
                                <CardImg className="mx-auto mt-3 border" src={"http://localhost:5555/" + this.state.renderpic2} style={{ height: "250px", width: "250px", objectFit: "cover" }} alt="Card image cap" />
                                <CardBody className="py-2">
                                    <CardText >
                                        <p>
                                            Select picture
                                ...
                                <CardFooter>
                                    <Button disabled={!this.state.productpic2} onClick={() => this.uploadPic2()} >Upload</Button>
                                </CardFooter>
                            </Card>
                            <Card style={{ width: "300px" }} className="mr-3">
                                <CardHeader>Product Picture 3</CardHeader>
                                <CardImg className="mx-auto mt-3 border" src={"http://localhost:5555/" + this.state.renderpic3} style={{ height: "250px", width: "250px", objectFit: "cover" }} alt="Card image cap" />
                                <CardBody className="py-2">
                                    <CardText >
                                        <p>
                                            Select picture
                                ...
                                <CardFooter>
                                    <Button disabled={!this.state.productpic3} onClick={() => this.uploadPic3()} >Upload</Button>
                                </CardFooter>
                            </Card>
                        </Row>
                        <Form style={{ backgroundColor: "#ffc61a" }} >
                            <FormGroup>
                                <p>
                                    ...
                                    <select style={{ height: "40px" }} className="mr-5" onClick={e => this.setState({ category: e.target.value })} >
                                    ...
                                    <label>Brand :&nbsp;</label>
                                    <input type="text" className="mr-5" style={{ width: "290px", borderRadius: "5px" }} onChange={e => this.setState({ brand: e.target.value })} />
                                    <label>Inventory :&nbsp;&nbsp;</label>
                                    <NumberFormat thousandSeparator={true} decimalScale="0" allowNegative={false} style={{ width: "50px", borderRadius: "5px" }} value={this.state.inventory} onChange={e => this.setState({ inventory: e.target.value })} />
                                ...
                                <p>
                                    <label>Name :&nbsp;</label>
                                    <input type="text" className="mr-5" style={{ width: "510px", borderRadius: "5px" }} onChange={e => this.setState({ name: e.target.value })} />
                                    <label>Price (IDR) :&nbsp;</label>
                                    <NumberFormat thousandSeparator={true} decimalScale="0" allowNegative={false} style={{ width: "210px", borderRadius: "5px" }} value={this.state.price} onChange={e => this.inputPrice(e.target.value)} />
                                </p>
                                <p>
                                    <label>Color :&nbsp;</label>
                                    <input type="text" className="mr-3" style={{ width: "200px", borderRadius: "5px" }} onChange={e => this.setState({ color: e.target.value })} />
                                    <label>Weight (kg/each) :&nbsp;</label>
                                    <NumberFormat className="mr-3" thousandSeparator={true} decimalScale="0" allowNegative={false} style={{ width: "50px", borderRadius: "5px" }} value={this.state.weight} onChange={e => this.setState({ weight: e.target.value })} />
                                    <label>Dimension (cm) :&nbsp;</label>
                                    <input placeholder="exp : length x width x height, or diameter" className="mr-3" style={{ width: "320px", borderRadius: "5px" }} onChange={e => this.setState({ dimension: e.target.value })} />
                                </p>
                                <p>
